...
//   describe('composer', () => {
//     const Tracker = {nonreactive: (cb: any) => cb()};
//     const getCollections = (post?: any) => {
//       const Collections = {
//         Posts: {findOne: stub()}
//       };
...
//         it('should call onData with data', (done: any) => {
//           const Meteor = {subscribe: stub()};
//           Meteor.subscribe.returns({ready: () => false});
//           const post = {aa: 10};
...
//         it('should call onData without nothing', (done: any) => {
//           const Meteor = {subscribe: stub()};
//           Meteor.subscribe.returns({ready: () => false});
//           const Collections = getCollections();
//
